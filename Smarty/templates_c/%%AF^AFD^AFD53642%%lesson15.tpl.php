<?php /* Smarty version 2.6.28, created on 2015-06-20 18:16:08
         compiled from lesson15.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'lesson15.tpl', 84, false),)), $this); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    .ajax span {
        width: 26px;
        height: 26px;
        background: rgb(175, 210, 35) none repeat scroll 0% 0%;
        display: block;
        right: 1em;
        position: absolute;
        cursor: pointer;
...
" placeholder="0" name="price" id="fld_price" type="text">&nbsp;<span>руб.</span>
    ...
    <div id="ajax-info" class="ajax">
        <span onclick="$('.ajax').remove().fadeOut('slow')">[x]</span>
...
"><?php echo $this->_tpl_vars['v']['title']; ?>
            ...
            <td><a class="delete" href='' data-del="<?php echo $this->_tpl_vars['v']['id']; ?>
">Удалить</a></td> 
       </tr>
