<?php /* Smarty version 2.6.28, created on 2015-05-30 10:35:02
...
" name="phone" id="fld_phone">
    ...
    <label for="region" class="form-label">Город</label> 
        <?php echo smarty_function_html_options(array('name' => 'location_id','options' => $this->_tpl_vars['citys'],'selected' => $this->_tpl_vars['location_id']), $this);?>

    </div>
    <div id="f_metro_id" class="form-row "> 
        <label for="metro_id" class="form-label">Метро</label>
        <?php echo smarty_function_html_options(array('name' => 'metro_id','options' => $this->_tpl_vars['underground'],'selected' => $this->_tpl_vars['metro_id']), $this);?>
